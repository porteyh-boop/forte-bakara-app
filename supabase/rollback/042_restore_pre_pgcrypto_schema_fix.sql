-- Rollback 042: restore provision_sales_lead_trial_portal as after migration 041
-- (unqualified gen_random_bytes; search_path = public). Does not drop pgcrypto extension.
