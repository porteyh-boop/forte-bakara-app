...
assert(provider.includes("createTavilyScoutResearchProvider"), "Tavily factory wired");
assert(!provider.includes("serper"), "no Serper implementation in provider switch");
